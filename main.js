...
level[0] = {
    start: function() {
        ...
        piegepik[2] = new component(254, 20, "white", 1716, 950);
        ...
        piegepik[7] = new component(146, 8, "white", 443, 1388); //trap3
        piegepik[8] = new component(152, 7, "white", 440, 1396); 
        piegepik[9] = new component(114, 8, "white", 599, 1232); //trap4
        piegepik[10] = new component(120, 7, "white", 596, 1240);
        piegepik[11] = new component(52, 8, "white", 724, 1450); //trap5
        piegepik[12] = new component(58, 12, "white", 721, 1458);
        piegepik[13] = new component(83, 8, "white", 849, 1357); //trap6
        piegepik[14] = new component(89, 7, "white", 846, 1365);
        piegepik[15] = new component(115, 8, "white", 1036, 1450); //trap7
        piegepik[16] = new component(121, 12, "white", 1033, 1458);
        piegepik[17] = new component(156, 20, "white", 1281, 1480);
        piegepik[18] = new component(125, 20, "white", 1532, 1980); // Stage4 //
        piegepik[19] = new component(93, 20, "white", 1282, 1980);
        piegepik[20] = new component(85, 13, "white", 1286, 1842); //trap 3
        piegepik[21] = new component(67, 7, "white", 1288, 1855);
        piegepik[22] = new component(405, 20, "white", 563, 1980); //trap 4
        piegepik[23] = new component(85, 13, "white", 723, 1779); //trap 5
        piegepik[24] = new component(67, 7, "white", 725, 1792);
        /*---------- Enemies -------*/
...
level[1] = {
    start: function() {
        ...
        platforme[4]= new component(96,2,"blue",608,416); // Plateform 1
        platforme[5]= new component(88,6,"blue",612,418);
        platforme[6]= new component(64,4,"blue",624,424);
        platforme[7]= new component(96,2,"blue",608,288); // Plateform 2
        platforme[8]= new component(88,6,"blue",612,290);
        platforme[9]= new component(64,4,"blue",624,296);
        platforme[10]= new component(96,2,"blue",768,352); // Plateform 3
        platforme[11]= new component(88,6,"blue",772,354);
        platforme[12]= new component(64,4,"blue",784,360);
        platforme[13]= new component(96,2,"blue",768,224); // Plateform 4
        platforme[14]= new component(88,6,"blue",772,226);
        platforme[15]= new component(64,4,"blue",784,232);
        platforme[16]= new component(96,2,"blue",928,160); // Plateform 5
        platforme[17]= new component(88,6,"blue",932,162);
        platforme[18]= new component(64,4,"blue",944,168);
        platforme[19]= new component(130,10,"blue",1023,381); // Plateform 6
        piegepik[1]= new component(116,8,"white",1030,366); // Trap
        piegepik[2]= new component(122,7,"white",1027,374);
        platforme[20]= new component(96,2,"blue",1152,160); // Plateform 7
        platforme[21]= new component(88,6,"blue",1156,162);
        platforme[22]= new component(64,4,"blue",1168,168);
        platforme[23]= new component(96,2,"blue",1248,416); // Plateform 8
        platforme[24]= new component(88,6,"blue",1252,418);
        platforme[25]= new component(64,4,"blue",1264,424);
        platforme[26]= new component(96,2,"blue",1504,416); // Plateform 9
        platforme[27]= new component(88,6,"blue",1508,418);
        platforme[28]= new component(64,4,"blue",1520,424);
        platforme[29]= new component(415,30,"blue",1696,481); // Ground
        platforme[30]= new component(26,60,"red",1924,420); // Pipe
        platforme[31]= new component(96,28,"red",2016,451);
        piegepik[3]= new component(610,15,"white",2112,496); // Trap
        platforme[32]= new component(160,26,"red",2208,355); // Pipe
        platforme[33]= new component(26,130,"red",2435,128);
        platforme[34]= new component(26,160,"red",2563,256);
        platforme[35]= new component(92,26,"red",2656,452);
        platforme[36]= new component(354,30,"blue",2720,481); // Ground
        platforme[37]= new component(130,32,"blue",2943,449); // Stairs
        platforme[38]= new component(96,32,"blue",2976,417);
        platforme[39]= new component(64,32,"blue",3009,385);
        platforme[40]= new component(32,30,"blue",3041,355);
        platforme[41]= new component(93,10,"blue",3043,353); // Plateform
        piegepik[4]= new component(255,15,"white",3073,496); // Trap
        platforme[42]= new component(123,10,"blue",3264,353); // Plateform
        platforme[43]= new component(65,158,"blue",3326,355);
        piegepik[5]= new component(767,15,"white",3393,496); // Trap
        platforme[44]= new component(32,10,"blue",3488,320); // Plateform
        platforme[45]= new component(32,10,"blue",3616,288);
        platforme[46]= new component(30,13,"blue",3745,256);
        platforme[47]= new component(32,10,"blue",3872,224);
        platforme[48]= new component(30,13,"blue",4001,192);
        platforme[49]= new component(90,10,"blue",4131,192); // Floating platform
        platforme[50]= new component(32,40,"blue",4160,446); // Wall
        piegepik[6]= new component(32,15,"white",4160,430);
        platforme[51]= new component(32,104,"blue",4192,382); // Wall
        piegepik[7]= new component(32,15,"white",4192,366);
        platforme[52]= new component(32,168,"blue",4224,318); // Wall
        piegepik[8]= new component(22,8,"white",4229,302);
        piegepik[9]= new component(28,7,"white",4226,310);
        platforme[53]= new component(32,34,"blue",4256,382); // Wall
        piegepik[10]= new component(22,8,"white",4261,366);
        piegepik[11]= new component(28,7,"white",4258,374);
        platforme[54]= new component(766,30,"blue",4160,481); // Ground
        piegepik[12]= new component(22,8,"white",4261,462);
        piegepik[13]= new component(28,10,"white",4258,470);
        platforme[55]= new component(32,9,"blue",4672,384); // Plateform
        platforme[56]= new component(65,2,"blue",4576,288); // platform 2
        platforme[57]= new component(61,6,"blue",4576,290);
        platforme[58]= new component(49,4,"blue",4576,296);
        platforme[59]= new component(32,130,"blue",4800,350); // Tree
        platforme[60]= new component(32,4,"blue",4768,418);
        platforme[61]= new component(32,4,"blue",4832,386);
        platforme[62]= new component(92,33,"blue",4770,318);
        platforme[63]= new component(124,59,"blue",4738,260);
        platforme[64]= new component(59,33,"blue",4803,228);
        piegepik[14]= new component(320,18,"white",4928,494); // Trap
        piegepik[15]= new component(96,18,"white",5344,494);
        piegepik[16]= new component(96,18,"white",5536,494);
        piegepik[17]= new component(160,18,"white",5728,494);
        platforme[65]= new component(92,22,"blue",4994,417); // Rolling platform
        platforme[66]= new component(96,32,"blue",5248,480); // Plateform1
        platforme[67]= new component(96,64,"blue",5440,448); // Plateform2
        platforme[68]= new component(96,96,"blue",5632,416); // Plateform3
        platforme[69]= new component(32,10,"blue",5856,352); // Plateform4
        platforme[69].walljump = false
        platforme[70]= new component(96,32,"blue",5632,288); // Plateform5
        platforme[71]= new component(96,32,"blue",5440,256); // Plateform6
        platforme[72]= new component(68,32,"blue",5454,288);
        platforme[73]= new component(96,32,"blue",5440,320);
        platforme[74]= new component(96,32,"blue",5248,224); // Plateform7
        platforme[75]= new component(68,100,"blue",5262,255);
        platforme[76]= new component(96,32,"blue",5248,352);
        platforme[77]= new component(800,32,"blue",5376,128); // Ground
        piegepik[18]= new component(85,8,"white",5446,110); // Trap1
        piegepik[19]= new component(91,10,"white",5443,118);
        piegepik[20]= new component(21,8,"white",5606,110); //trap2
        piegepik[21]= new component(28,10,"white",5602,118);
        piegepik[22]= new component(116,8,"white",5702,110); //trap3
        piegepik[23]= new component(122,10,"white",5699,118);
        platforme[78]= new component(26,130,"red",6275,0); // Pipe
        platforme[79]= new component(320,97,"blue",5888,160); // Ground
        platforme[80]= new component(224,33,"blue",5888,256);
        platforme[81]= new component(192,98,"blue",5888,288);
        platforme[82]= new component(224,33,"blue",5888,385);
        platforme[83]= new component(256,33,"blue",5888,417);
        platforme[84]= new component(320,33,"blue",5888,449);
        platforme[85]= new component(31,10,"blue",6337,192); // Plateform
        platforme[86]= new component(128,32,"blue",6368,160); // Ground
        platforme[87]= new component(160,32,"blue",6368,192);
        platforme[88]= new component(224,32,"blue",6368,224);
        platforme[89]= new component(224,32,"blue",6464,255);
        platforme[90]= new component(288,32,"blue",6496,287);
        platforme[91]= new component(320,32,"blue",6496,319);
        platforme[92]= new component(352,32,"blue",6496,351);
        platforme[93]= new component(480,33,"blue",6464,383);
        platforme[94]= new component(608,33,"blue",6432,416);
        platforme[95]= new component(736,33,"blue",6368,449);
        platforme[96]= new component(2304,30,"blue",5888,481);
        platforme[97]= new component(31,512,"blue",8192,0); // Wall
        
        /* ----------- Ceilling ----------- */
        platforme[98]= new component(161,95,"blue",30,0);
        platforme[99]= new component(96,63,"blue",191,0);
        platforme[100]= new component(286,95,"blue",257,0);
        platforme[101]= new component(161,63,"blue",543,0);
        platforme[102]= new component(190,95,"blue",705,0);
        platforme[103]= new component(160,63,"blue",895,0);
        platforme[104]= new component(193,31,"blue",1055,0);
        platforme[105]= new component(638,63,"blue",1249,0);
        platforme[106]= new component(222,32,"blue",1281,63);
        platforme[107]= new component(190,32,"blue",1601,63);
        platforme[108]= new component(1124,31,"blue",1851,0);
        platforme[109]= new component(446,31,"blue",1985,31);
        platforme[110]= new component(94,32,"blue",2017,62);
        platforme[111]= new component(254,33,"blue",2177,62);
        platforme[112]= new component(94,33,"blue",2241,94);
        platforme[113]= new component(222,33,"blue",2497,30);
        platforme[114]= new component(93,32,"blue",2530,62);
        platforme[115]= new component(381,63,"blue",2753,0);
        platforme[116]= new component(1213,95,"blue",2849,0);
        platforme[117]= new component(158,32,"blue",2977,94);
        platforme[118]= new component(158,96,"blue",3329,94);
        platforme[119]= new component(191,33,"blue",3487,94);
        platforme[120]= new component(190,33,"blue",3777,94);
        platforme[121]= new component(898,63,"blue",4062,0);
        platforme[122]= new component(670,33,"blue",4225,62);
        platforme[123]= new component(542,33,"blue",4289,95);
        platforme[124]= new component(350,32,"blue",4353,128);
        platforme[125]= new component(222,32,"blue",4385,160);
        platforme[126]= new component(190,128,"blue",4385,192);
        platforme[127]= new component(128,32,"blue",4352,320);
        piegepik[24]= new component(32,17,"white",4352,303); // Trap
        platforme[128]= new component(96,32,"blue",4352,352);
        platforme[129]= new component(128,31,"blue",4320,384);
        piegepik[25]= new component(22,8,"white",4325,366); // Trap
        piegepik[26]= new component(28,10,"white",4322,374);
        platforme[130]= new component(350,95,"blue",4961,0);
        platforme[131]= new component(579,31,"blue",5311,0);
        platforme[132]= new component(191,63,"blue",5889,0);
        platforme[133]= new component(481,31,"blue",6080,0);
        platforme[134]= new component(255,63,"blue",6561,0);
        platforme[135]= new component(255,127,"blue",6816,0);
        platforme[136]= new component(1121,32,"blue",7071,0);
        platforme[137]= new component(191,32,"blue",7071,31);
        platforme[138]= new component(160,32,"blue",7071,62);
